...
const EmployeeDashboard: React.FC = () => {
    ...
    return (
        <div className="mx-auto flex max-w-7xl w-full flex-col gap-4 md:gap-6 px-4 py-4 sm:px-6 sm:py-6 lg:px-8 lg:py-5 min-h-auto">

            <div className="space-y-2">
                <h1 className="text-xl md:text-2xl lg:text-3xl font-bold tracking-tight">My Activity Workspace</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mt-4">
                <Card className="hover:shadow-md transition-shadow duration-300 border border-border">
                    <CardHeader className="pb-4">
                        <CardTitle className="text-lg font-semibold">Your Timesheets Status</CardTitle>
                    </CardHeader>
                    <CardContent>
