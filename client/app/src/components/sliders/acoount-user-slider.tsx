...
// import { LayoutDashboard, LogOut, ListChecksIcon } from "lucide-react"

// const navlinks = [
//   { to: "/accountuser/dashboard", label: "Dashboard", icon: LayoutDashboard },
//   { to: "/accountuser/invoice", label: "Invoice", icon: ListChecksIcon },
// ]
...
// export function AccountuserSidebar({
//   user = {
//     name: "Account User",
//     email: "accountuser@company.com",
//     avatarUrl: "",
//   },
//   onLogout,
//   ...props
...
const mainItems: SideBarItem[] = [
  {
    title: "Dashboard",
    url: "/accountuser/dashboard",
    icon: "dashboard",
  },
  {
    title: "Invoice",
    url: "/accountuser/invoice",
    icon: "invoice"
  }
]


export function AccountUserSlider({ ...props }: React.ComponentProps<typeof Sidebar>) {
